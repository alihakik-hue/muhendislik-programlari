const CACHE='muhendislik-v1-20260925';
const CORE=['./','./index.html','./manifest.webmanifest','./apps/hangar/index.html','./apps/profil-kesim/index.html','./apps/plaka-nesting/index.html'];
